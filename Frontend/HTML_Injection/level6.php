<?php
  ...
  include "../../Backend/Library/HTMLInj_Function.php";
  $htmlInj = new HTMLInj();
...
<head>
  ...
  <title>HTML Injection seviye 6</title>
</head>
        ...
        <div style="margin-top:3%;">
          ...
          <?php
            ...
            if (isset($_GET["name"])) {
              ...
              echo "<span style='font-weight:bolder;font-size:25px'>Hoşgeldin </span>" . $htmlInj->level6($_GET['name']);
