        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <form class="form-signin" action="<?php $_PHP_SELF ?>" method="post">
                 <h2 class="form-signin-heading"><?=$_SESSION["name"]?>'in password'unu değiştir</h2>
                 <input type="password" id="password" name="pass1" class="form-control" placeholder="Password" required>
                 <input type="password" id="password" name="pass2" class="form-control" placeholder="Password" required>
               ...
               <?php
                 ...
                 if (isset($_POST["pass1"]) && isset($_POST["pass2"]) ){
                  $csrf->changePass($_SESSION["id"],$_POST["pass1"],$_POST["pass2"]);
                }
                ?>
