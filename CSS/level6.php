...
<head>
    ...
    <title>Cross Site Scripting seviye 6</title>
</head>
<body>
            ...
            <div class="col-md-6">
                ...
                <div style="margin-top:3%;">
                    <?php
                     ...
                     /*
                      Burada script içersinde alert keyword'u aranıyor daha sonra ise bulunursa error verecek
                     */


                        $lower = strtolower($tmp);
                        if (strpos($lower, 'alert') !== false)
                        {
                            echo 'error';
                        }
                        else
