...
<body>
    ...
    <div class="container" style="margin-top: 5%">
        <div class="card-deck mb-3 text-center">
            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-header">
                    <h4 class="my-0 font-weight-normal"><a href="Frontend/Code_Injection/level0.php" style="color: black">Mixed</a></h4>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mt-3 mb-4">
                      <li><h5><a href="Frontend/Different_Type/IDOR/Idor_Login.php">Insecure Direct Object Reference 1</a></h5></li>
                      <li><h5><a href="#">Insecure Direct Object Reference 2 </a></h5></li>
                      <li><h5><a href="Frontend/Code_Injection/level3.php">Server Side Template Injection (Bakılacak) </a></h5></li>
                      <li><h5><a href="Frontend/Different_Type/CSRF/CSRF_ChangePassword.php">Cross Site Request Forgery</a></h5></li>
                      <li><h5><a href="Frontend/Different_Type/HTTP/Http_POST_Login.php">HTTP POST Brute Force</a></h5></li>
                      <li><h5><a href="Frontend/Different_Type/HTTP/Http_Get_Login.php">HTTP GET Brute Force</a></h5></li>
                      <li><h5><a href="Frontend/Different_Type/XXE/xxe.php">XML External Entity</a></h5></li>
                      <li><h5><a href="Frontend/Different_Type/XPATH/Xpath_Login.php">XPATH Injection</a></h5></li>
                      <li><h5><a href="#">HTML Parameter Population</a></h5></li>
                      <li><h5><a href="#">HTTP Request/Header Injection</a></h5></li>
                      <li><h5><a href="#">Restrict Device Access</a></h5></li>
                      <li><h5><a href="#">Seviye 9</a></h5></li>
                    </ul>
                  </div>
            </div>
            ...
            <div class="card mb-3 shadow-sm">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mt-3 mb-4">
                        ...
                        <li><h5><a href="Frontend/Code_Injection/level4.php">Server-Side Includes Injection (Bakılacak)</a></h5></li>
                        <li><h5><a href="Frontend/Different_Type/JS_Bypass/JS_Bypass.php">JavaScript Validation Bypass(OWASP)</a></h5></li>
                        <li><h5><a href="Frontend/Different_Type/Directory_Traversal/DT.php?page=include/html/statistics.html">Directory Travelsal</a></h5></li>
                        <li><h5><a href="Frontend/Code_Injection/level5.php">Blind SQL Injection</a></h5></li>
                        <li><h5><a href="#">Stored XXS</a></h5></li>
                        <li><h5><a href="#">Remote file include</a></h5></li>
                        <li><h5><a href="#">Login SQL Injection</a></h5></li>
                        <li><h5><a href="#">Referer Injection</a></h5></li>
                    </ul>
                  </div>
            </div>
